...
function exportData(type) {
    ...
    switch(type) {
        case 'admissions':
            exportUrl = 'api/export_admissions.php';
            break;
        case 'students':
            exportUrl = 'api/export_students_data.php';
            break;
        case 'all':
            exportUrl = 'api/export_all.php';
            break;
        default:
...
function loadAdmissionsList() {
    // Show loading state
    $('#admissionsTable tbody').html('<tr><td colspan="8" class="text-center"><i class="fas fa-spinner fa-spin"></i> Loading...</td></tr>');
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status === 'success') {
                ...
                $('#admissionsTable tbody').html('<tr><td colspan="8" class="text-center text-danger">Error: ' + (response.message || 'Unknown error') + '</td></tr>');
            }
        },
        error: function(xhr, status, error) {
            console.log('Error loading admissions list:', error);
            $('#admissionsTable tbody').html('<tr><td colspan="8" class="text-center text-danger">Failed to load admissions data</td></tr>');
        }
    });
}
...
function loadStudentsList() {
    // Show loading state
    $('#studentsTable tbody').html('<tr><td colspan="9" class="text-center"><i class="fas fa-spinner fa-spin"></i> Loading...</td></tr>');
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status === 'success') {
                ...
                $('#studentsTable tbody').html('<tr><td colspan="9" class="text-center text-danger">Error: ' + (response.message || 'Unknown error') + '</td></tr>');
            }
        },
        error: function(xhr, status, error) {
            console.log('Error loading students list:', error);
            $('#studentsTable tbody').html('<tr><td colspan="9" class="text-center text-danger">Failed to load students data</td></tr>');
        }
    });
}
